...
let html = "";
html = `<div class="card">
<div class="card-header">🏠&nbsp; Selamat Datang di Beranda Drive</div>
...
html += `</div><div class="card-footer text-muted d-flex align-items-center gap-2"><span class="badge text-bg-dark">${len} drive</span></div></div>`;
$('#list').html(html);
