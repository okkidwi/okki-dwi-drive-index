  ...
  <div class="col-lg-6 col-md-12">
    <div class="card text-white mb-3 h-100">
      ...
      <div class="card-body d-flex flex-wrap gap-2 justify-content-center align-items-center">
        <a href="https://www.facebook.com/groups/153401064271807t" target="_blank" title="Gabung sekarang!" style="margin-right: 8px;">
          <img class="image" alt="Facebook" style="height: 33px;" src="https://raw.githubusercontent.com/okkidwi/okkidwi-drive-index/master/images/logo-facebook.png">
        </a>
        <a href="https://yoviratv.blogspot.com" target="_blank" title="Unduh sekarang!" style="margin-left: 8px;">
          <img class="image" alt="Yovira TV" style="height: 33px;" src="https://raw.githubusercontent.com/okkidwi/okkidwi-drive-index/master/images/logo-yovira-tv.png">
        </a>
      </div>
    </div>
  </div>
...
function nav(path) {
  ...
  <a class="navbar-brand d-flex align-items-center gap-2" href="/">${UI.logo_image ? '<img border="0" alt="'+UI.company_name+'" src="'+UI.logo_link_name+'" height="'+UI.logo_height+'" width="'+UI.logo_width+'">'+UI.siteName : UI.logo_link_name}<span class="badge rounded-pill bg-success">Drive</span></a>
...
<div class="input-group">
	<input class="form-control" name="q" type="search" placeholder="Cari ..." aria-label="Search" value="${search_text}" style="border-right:0;" required>
